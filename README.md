...
For extracting HOG features, consider get_hog_features() API in ["main.py"](./main.py)
...
### Training a classifier and scaler (Refer ["main.py"](./main.py) #33 to #175 and #380 to #441
...
### Rubric: Sliding Window Search (Refer ["main.py"](./main.py) #176 to #230
...
1) Scaled sliding window
  ...
  * Refer to the image ["Sliding scaled windows"](./images/sliding_window_scaled_windows.jpg) for visualization of the sliding scaled windows

  !["Sliding scaled windows"](./images/sliding_window_scaled_windows.jpg)
...
2) Constant size sliding window with scaled image
  ...
  * Refer to the image ["Scaled image constant sliding windows"](./images/sliding_window_scaled_image.jpg) for visualization of the sliding constant windows on scaled image

  !["Scaled image constant sliding windows"](./images/sliding_window_scaled_image.jpg)
...
Steps involved:
 ...
 ![Example images "Vehicle"](./images/vehicle.png)
 Example image "Vehicle"


 ![Example images "Non-vehicle"](./images/non-vehicle.png)
 ...
 !["Vehicle" image with HOG features](./images/car_HOG.png)
 "Vehicle" image with HOG features

 !["Non-vehicle" image with HOG features](./images/notcar_HOG.png)
...
Heat map during vehicle detection is as shown below
 ...
 !["Vehicle" detection heat map with history](./images/heatmap_heat_history.png)
...
["Execution video"](./output_video.avi)

### Bounding boxes drawn onto the input frame:

!["Vehicle" detection output](./images/detected_cars.png)
